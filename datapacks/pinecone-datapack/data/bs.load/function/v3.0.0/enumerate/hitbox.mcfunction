...
data modify storage bs:data load.modules append value {module:"bs.hitbox",version:"3.0.0",enabled:0b}
...
execute if score $bs.hitbox.major load.status matches 3 unless score $bs.hitbox.minor load.status matches ..0 run return 0
execute if score $bs.hitbox.major load.status matches 3 if score $bs.hitbox.minor load.status matches 0 unless score $bs.hitbox.patch load.status matches ..0 run return 0
