...
data modify storage bs:data load.modules append value {module:"bs.raycast",version:"3.0.0",enabled:0b}
...
execute if score $bs.raycast.major load.status matches 3 unless score $bs.raycast.minor load.status matches ..0 run return 0
execute if score $bs.raycast.major load.status matches 3 if score $bs.raycast.minor load.status matches 0 unless score $bs.raycast.patch load.status matches ..0 run return 0
